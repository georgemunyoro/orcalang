...
CmpGTOperator *CmpGTOperator::instance = nullptr;

OrcaType *CmpGTOperator::getResultingType(OrcaType *lhs, OrcaType *rhs) {
...
llvm::Value *CmpGTOperator::codegen(OrcaCodeGen &cg, OrcaAstExpressionNode *lhs,
  ...
  case OrcaTypeKind::Integer: {
    ...
    if (lInt.getIsSigned())
      return cg.builder->CreateICmpSGT(lhsVal, rhsVal);

    return cg.builder->CreateICmpUGT(lhsVal, rhsVal);
  }

  case OrcaTypeKind::Float: {
    return cg.builder->CreateFCmpOGT(lhsVal, rhsVal);
  }
