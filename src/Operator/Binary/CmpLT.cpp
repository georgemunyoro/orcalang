...
CmpLTOperator *CmpLTOperator::instance = nullptr;

OrcaType *CmpLTOperator::getResultingType(OrcaType *lhs, OrcaType *rhs) {
...
llvm::Value *CmpLTOperator::codegen(OrcaCodeGen &cg, OrcaAstExpressionNode *lhs,
  ...
  case OrcaTypeKind::Integer: {
    ...
    if (lInt.getIsSigned())
      return cg.builder->CreateICmpSLT(lhsVal, rhsVal);

    return cg.builder->CreateICmpULT(lhsVal, rhsVal);
  }

  case OrcaTypeKind::Float: {
    return cg.builder->CreateFCmpOLT(lhsVal, rhsVal);
  }
