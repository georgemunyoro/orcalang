...
CmpGEOperator *CmpGEOperator::instance = nullptr;

OrcaType *CmpGEOperator::getResultingType(OrcaType *lhs, OrcaType *rhs) {
...
llvm::Value *CmpGEOperator::codegen(OrcaCodeGen &cg, OrcaAstExpressionNode *lhs,
  ...
  case OrcaTypeKind::Integer: {
    ...
    if (lInt.getIsSigned())
      return cg.builder->CreateICmpSGE(lhsVal, rhsVal);

    return cg.builder->CreateICmpUGE(lhsVal, rhsVal);
  }

  case OrcaTypeKind::Float: {
    return cg.builder->CreateFCmpOGE(lhsVal, rhsVal);
  }
